...
var dq = d.getMonth()+""+d.getDate()+""+d.getHours();
    	var feed = new google.feeds.Feed("http://www.amazon.co.jp/gp/rss/most-wished-for/food-beverage/2427750051/ref=zg_mw_2427750051_rsslink&tag=anibull-22"+"?"+dq); //RSSを指定
